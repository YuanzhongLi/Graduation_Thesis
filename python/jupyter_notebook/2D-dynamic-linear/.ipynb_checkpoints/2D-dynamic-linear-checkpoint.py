...
plot_compare_abaqus_dis(abaqus_dis, disG, [11], True, '3sec-dis')

plot_compare_abaqus_e_dis(abaqus_coordsG_e_dis, coordsG_e_dis, [11], True, '3sec-edis')

plot_compare_abaqus_dis(abaqus_dis2, disG2, [11], True, '1sec-dis')
...
plot_compare_abaqus_dis(abaqus_dis4, disG4, [11], True, '03sec-dis')
